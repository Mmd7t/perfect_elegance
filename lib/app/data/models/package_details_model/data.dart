...
class VanexData {
  ...
  factory VanexData.fromJson(Map<String, dynamic> json) => VanexData(
        ...
        deliveryDate: json['delivery_date'] as dynamic,
        ...
        isDeposit: json['is_deposit'] as int?,
        ...
        subCity: json['sub_city'] == null
            ? null
            : SubCity.fromJson(json['sub_city'] as Map<String, dynamic>),
