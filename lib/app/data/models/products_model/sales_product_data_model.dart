import 'package:perfect_elegance/app/data/models/products_model/sizes_list.dart';

class SalesProductDataModel {
  int? id;
  int? userId;
  int? storeId;
  dynamic brandId;
  ...
  String? fullImage;
  List<SizesList>? sizesList;
  List<dynamic>? promptDeliveryProductIds;

  SalesProductDataModel({
    this.id,
    this.userId,
    this.storeId,
    this.brandId,
  ...
  factory SalesProductDataModel.fromJson(Map<String, dynamic> json) {
    return SalesProductDataModel(
      id: json['id'] as int?,
      ...
      sizesList: (json['SizesList'] as List<dynamic>?)
          ?.map((e) => SizesList.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'SizesList': sizesList?.map((e) => e.toJson()).toList(),
